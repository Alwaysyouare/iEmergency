...
@interface ICINewFeatureViewController () <UIScrollViewDelegate>
@property (nonatomic, weak) UIPageControl *pageControl;
@end

@implementation ICINewFeatureViewController
...
- (void)setupPageControl
{
    ...
    // 2.设置圆点的颜色
    pageControl.currentPageIndicatorTintColor = ICIColor(253, 98, 42); // 当前页的小圆点颜色
    pageControl.pageIndicatorTintColor = ICIColor(189, 189, 189); // 非当前页的小圆点颜色
